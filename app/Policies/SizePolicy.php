...
class SizePolicy
{
    ...
    {
        return $user->hasPermissionTo('view size');
    }
    ...
    {
        return $user->hasPermissionTo('create size');
    }
    ...
    {
        return $user->hasPermissionTo('edit size');
    }
    ...
    {
        return $user->hasPermissionTo('delete size');   
    }
