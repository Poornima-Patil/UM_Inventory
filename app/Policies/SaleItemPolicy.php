...
class SaleItemPolicy
{
    ...
    {
        return $user->hasPermissionTo('view saleItem');
    }
    ...
    {
        return $user->hasPermissionTo('create saleItem');
    }
    ...
    {
        return $user->hasPermissionTo('edit saleItem');
    }
    ...
    {
        return $user->hasPermissionTo('delete saleItem');
    }
